...
- Download the NAR package from [here](https://github.com/streamnative/pulsar-io-amqp-1-0/releases/download/v2.10.1.10-rc-arrowstreet/pulsar-io-amqp1_0-2.10.1.10-rc-arrowstreet.nar).
...
- Build it from the source code.
  ...
  2. Assume that `PULSAR_IO_AMQP1_0_HOME` is the home directory for the `pulsar-io-amqp1_0` repo. Build the connector in the `${PULSAR_IO_AMQP1_0_HOME}` directory.
        ...
        pulsar-io-amqp1_0-2.10.1.10-rc-arrowstreet.nar
        ```
...
* JSON 
    ...
    ```json
    {
        ...
        "archive": "connectors/pulsar-io-amqp1_0-2.10.1.10-rc-arrowstreet.nar",
        "parallelism": 1,
        "configs":
        {
            "protocol": "amqp",
...
spec:
  image: streamnative/pulsar-io-amqp-1-0:2.10.1.10-rc-arrowstreet
  ...
  resources:
    ...
    memory: 1G
  java:
    jar: connectors/pulsar-io-amqp1_0-2.10.1.10-rc-arrowstreet.nar
...
--name amqp1_0-sink \
--archive pulsar-io-amqp1_0-2.10.1.10-rc-arrowstreet.nar \
--classname org.apache.pulsar.ecosystem.io.amqp.AmqpSink \
...
2. Copy the NAR package of the AMQP1_0 sink connector to the Pulsar connectors directory.
    ...
    ```
    cp pulsar-io-amqp1_0-2.10.1.10-rc-arrowstreet.nar $PULSAR_HOME/connectors/pulsar-io-amqp1_0-2.10.1.10-rc-arrowstreet.nar
    ```
...
3. Start Pulsar in standalone mode.
    ...
    **Output**
    ...
    Found connector ConnectorDefinition(name=amqp1_0, description=AMQP1_0 source and AMQP1_0 connector, sourceClass=org.apache.pulsar.ecosystem.io.amqp.AmqpSource, sinkClass=org.apache.pulsar.ecosystem.io.amqp.AmqpSink, sourceConfigClass=null, sinkConfigClass=null) from /Volumes/other/apache-pulsar-2.8.0-SNAPSHOT/./connectors/pulsar-io-amqp1_0-2.10.1.10-rc-arrowstreet.nar
