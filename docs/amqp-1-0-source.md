...
- Download the NAR package from [here](https://github.com/streamnative/pulsar-io-amqp-1-0/releases/download/v3.0.1.3/pulsar-io-amqp1_0-3.0.1.3.nar).
...
* JSON 
    ...
    ```json
    {
        ...
        "archive": "connectors/pulsar-io-amqp1_0-3.0.1.3.nar",
        "parallelism": 1,
        "configs": {
            "protocol": "amqp",
            "host": "localhost",
...
spec:
  image: streamnative/pulsar-io-amqp-1-0:3.0.1.3
  ...
  resources:
    ...
    memory: 1G
  java:
    jar: connectors/pulsar-io-amqp1_0-3.0.1.3.nar
...
--name amqp1_0-source \
--archive pulsar-io-amqp1_0-3.0.1.3.nar \
--classname org.apache.pulsar.ecosystem.io.amqp.AmqpSource \
...
2. Copy the NAR package of the AMQP1_0 source connector to the Pulsar connectors directory.
    ...
    ```
    cp pulsar-io-amqp1_0-3.0.1.3.nar $PULSAR_HOME/connectors/pulsar-io-amqp1_0-3.0.1.3.nar
    ```
...
3. Start Pulsar in standalone mode.
    ...
    **Output**
    ...
    Found connector ConnectorDefinition(name=amqp1_0, description=AMQP1_0 source and AMQP1_0 connector, sourceClass=org.apache.pulsar.ecosystem.io.amqp.AmqpSource, sinkClass=org.apache.pulsar.ecosystem.io.amqp.AmqpSink, sourceConfigClass=null, sinkConfigClass=null) from /Volumes/other/apache-pulsar-2.8.0-SNAPSHOT/./connectors/pulsar-io-amqp1_0-3.0.1.3.nar
