...
- Download the NAR package from [here](https://github.com/streamnative/pulsar-io-amqp-1-0/releases/download/v2.10.0.1/pulsar-io-amqp1_0-2.10.0.1.nar).
...
- Build it from the source code.
  ...
  2. Assume that `PULSAR_IO_AMQP1_0_HOME` is the home directory for the `pulsar-io-amqp1_0` repo. Build the connector in the `${PULSAR_IO_AMQP1_0_HOME}` directory.
        ...
        pulsar-io-amqp1_0-2.10.0.1.nar
        ```
...
* JSON 
    ...
    ```json
    {
        ...
        "archive": "connectors/pulsar-io-amqp1_0-2.10.0.1.nar",
        "parallelism": 1,
        "configs": {
            "protocol": "amqp",
            "host": "localhost",
...
spec:
  image: streamnative/pulsar-io-amqp-1-0:2.10.0.1
  ...
  resources:
    ...
    memory: 1G
  java:
    jar: connectors/pulsar-io-amqp1_0-2.10.0.1.nar
...
--name amqp1_0-source \
--archive pulsar-io-amqp1_0-2.10.0.1.nar \
--classname org.apache.pulsar.ecosystem.io.amqp.AmqpSource \
...
2. Copy the NAR package of the AMQP1_0 source connector to the Pulsar connectors directory.
    ...
    ```
    cp pulsar-io-amqp1_0-2.10.0.1.nar $PULSAR_HOME/connectors/pulsar-io-amqp1_0-2.10.0.1.nar
    ```
...
3. Start Pulsar in standalone mode.
    ...
    **Output**
    ...
    Found connector ConnectorDefinition(name=amqp1_0, description=AMQP1_0 source and AMQP1_0 connector, sourceClass=org.apache.pulsar.ecosystem.io.amqp.AmqpSource, sinkClass=org.apache.pulsar.ecosystem.io.amqp.AmqpSink, sourceConfigClass=null, sinkConfigClass=null) from /Volumes/other/apache-pulsar-2.8.0-SNAPSHOT/./connectors/pulsar-io-amqp1_0-2.10.0.1.nar
